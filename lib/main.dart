...
void main() async {
  ...
  runApp(MaterialApp(
    ...
    routes: {
      ...
      //'/provider_list': (context) => ProviderList(),
      '/user_settings': (context) => const UserSettings(),
      '/athlete_profiles': (context) => const AthleteList(),
      //'/athlete_profile': (context, int athleteid) => AthleteProfile(athleteId: athleteid,),
      //'/update_athlete_profile': (context) => UpdateAthleteProfile(),
